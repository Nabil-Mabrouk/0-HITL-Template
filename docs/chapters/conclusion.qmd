...
En douze chapitres, nous sommes partis d'une page blanche pour arriver à une plateforme d'apprentissage complète, sécurisée et pilotée par la donnée. Le projet **0-HITL** est désormais une réalité technique prête pour la production.
...
7.  **Infrastructure-as-Code :** Déploiement reproductible et automatisé via Docker Compose.
...
*   **Intégration IA :** Utiliser les profils d'usage pour générer des parcours d'apprentissage personnalisés via LLM.
*   **CI/CD :** Automatiser les tests et le déploiement via GitHub Actions.
*   **Interactivité :** Ajouter des quiz et des exercices pratiques validés automatiquement côté backend.
*   **Communauté :** Implémenter un système de commentaires et de forums sous chaque leçon.
